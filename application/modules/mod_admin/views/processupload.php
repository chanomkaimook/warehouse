...
$max_image_size = $this->set['max_size_image']; //Maximum image size (height and width)
$thumb_prefix = "thumb_"; //Normal thumb Prefix


$destination_folder = $_SERVER['DOCUMENT_ROOT'].$basepathpic;
$destination_folder .= $_POST['locationflie']."/"; //upload directory ends with / (slash)	*/
//$destination_folder = $_SERVER['DOCUMENT_ROOT']."/asset/images/front/";		//path web
//$destination_folder .= "board/";		//path web
$jpeg_quality = 90; //jpeg quality
// $number = $this->mdl_sql->get_WhereTableNum($_POST['mode']);
$countmax = $_POST['countmax'];
// echo '<pre>'; print_r($_POST['countmax']); exit;
##########################################
//echo $_POST['mode']." ******";
...
if (isset($_POST) == 'xmlhttprequest') {	
    ...
    if ($image_res) {
        ...
        $new_file_name = $image_name_only.'_'.$countmax.'.' . $image_extension;
      
        //folder path to save resized images and thumbnails
        $thumb_save_folder = $destination_folder . $thumb_prefix . $new_file_name;
        $image_save_folder = $destination_folder . $new_file_name;
		// if($_POST['mode'] == 'board'){
		// 	$this->mdl_sql->update_TableWhere($_POST['mode'],'pic',$new_file_name,$number);
		// }
