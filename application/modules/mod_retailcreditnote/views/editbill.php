        ...
        $(function() {
            ...
            $(document).on('change', '#select_return', function() {
                ...
                if (select_return.val() == 1) {
                    ...
                    $('*[for=totalzero]').removeClass('d-none');

                    if (totalamount.val() <= 0) { // หากบิลมีราคาไม่เท่ากับ 0 ให้เเสดงราคาไม่ต้องบังคับ 0
                        forceZero();
                    }
                } else {
            ...
            function formDataInsert(bill) {
                ...
                } else if (!bill.approve_store && !bill.approve_store) {
