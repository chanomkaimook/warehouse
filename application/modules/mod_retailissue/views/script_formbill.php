<script>
    ...
    function add_Bill() {
        ...
        data.append('billto', document.getElementById('billto').value);
        data.append('sp_bill_id', "");
        data.append('sp_bill_name', "");

        
        if($('#sel_supplier').val()){
            data.append('bill_type', 4);    //  คืนสินค้า
            data.append('sp_bill_id', $('#sel_supplier').val());    //  supplier bill id
            data.append('sp_bill_name', $('#sel_supplier').find(":selected").attr('data-sname'));    //  supplier bill id
        }else{
            data.append('bill_type', document.getElementById('sel_issue').value);
        }
