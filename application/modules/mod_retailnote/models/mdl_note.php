...
class Mdl_note extends CI_Model
{
    ...
    function make_query()
    {
        ...
        $this->db->from($table);
        $this->db->join($tabledetail, $table.'.id='.$tabledetail.'.rt_note_id','left');
        $this->db->join('retail_productlist', 'if('.$tabledetail.'.LIST_ID,'.$tabledetail.'.LIST_ID = retail_productlist.ID,'.$tabledetail.'.PROLIST_ID = retail_productlist.ID)', 'left',false);
