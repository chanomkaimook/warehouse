                        ...
                        <section class="col-lg-12 connectedSortable">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <?php
                                    if (chkPermissPage('report_receive') && $query->COMPLETE == 2) {
                                    ?>
                                ...
                                <div id="container" class="card-body">
                                    ...
                                    <input type="hidden" id="permit_returnapprove" name="permit_returnapprove" value="<?php echo (chkPermissPage('return_receive') ? 1 : null); ?>">
    ...
    <script>
        ...
        $(function() {
            ...
            function formDataInsert(bill) {
                ...
                frm.find('.bill_ref2').text(bill.cn_bill_code);
                ...
                frm.find('.bill_supplier').text(bill.sup_name);
                ...
                if(bill.is_bill_name){
                    frm.find('.bill_name').text(bill.is_bill_name+' (ผู้ยืม)');
                }else{
