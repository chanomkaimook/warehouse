<script>
    ...
    function add_Bill() {
        ...
        data.append('type',$('input#type').prop('checked'));
        data.append('selectsupplier', document.getElementById('selectsupplier').value);
        data.append('ref1', document.getElementById('ref1').value);
