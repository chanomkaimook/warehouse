    ...
    if ($('body').data('page') == 'login') {
        ...
        $('#submit-form').click(function(e) {
            ...
            if (form.valid()) {
				...
				var linkx = window.location.host + '/whatisit_backend/mod_admin/signin';
				...
				$.post( linkx, data)
				  .done(function(response) {
						...
						if(obj.error_code == 'E00'){
							window.location=window.location.host + '/whatisit_backend/mod_admin/dashboard';
						}else{
							alert(obj.error_text_th);
							$('#submit-form :input').val(null);
						}
