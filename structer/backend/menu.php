...
?>
<style>
	nav li.has-treeview , ul.nav-treeview li{
		display:none;
	}
...
<!-- Main Sidebar Container -->
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="<?php echo $siteurl."/ctl_admin/backend_main"; ?>" class="brand-link">
				<img src="<?php echo $base_bn;?>dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
					style="opacity: .8">
			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-header">Manage basic information<li>
